...
set xlabel "x"
set ylabel "y"
plot 2*x**2*sqrt(x)-5*x**2 w l title "f1(x)",x/log(x) w l t "f2(x)"
...
plot "weather2024.csv" u 1:2 w l t "最高気温","weather2024.csv" u 1:3 w l t "最高気温(平年)","weather2024.csv" u 1:4 w l title "最低気温","weather2024.csv" u 1:5 w l t "最低気温(平年)"
```
